/////Bootcamps 3.0 - .NET - Clase 3
/*
A continuación un compendio de líneas de ejemplo de lo que vimos en la clase, que pueden utilizar para realizar los ejercicios. 
*/
...
//También se puede inferir el tipo de dato usando var
//ej
var numero = 1;

/*
 Recuerden que las variables pueden tener cualquier nombre, pero respetando:
puede:
empezar por "_".
...
var resultado_ternario = (incremento % 2) == 0 ? "ES PAR" : "NO ES PAR. ES IMPAR";
Console.WriteLine(resultado_ternario);
...
//Por ahora lo usaremos con el tipo string, que podría tratarse como un conjunto de char
string cadena = "Un conjunto de caracteres";
foreach (char c in cadena)
{
    Console.WriteLine(c); //Esto imprimirá cada caracter de la cadena en la consola
}
#endregion
...
//Donde TryParse convierte a int y lo guarda en la variable que le pasemos luego de 'out'. Y si es null 
#endregion

#region EjemplosDeMenú
string texto;

//Uso de do-while para menú de opciones
do
{
    ...
    switch (texto)
    {
        ...
        case "4":
            ...
            Console.WriteLine("El resultado de la división es: " + (num7 / num8));
            break;
        case "5":
...
//Al usar while para menú de opciones, generalmente se imprime el menú antes del while, una vez
Console.WriteLine("Ingrese una opción: ");
Console.WriteLine("1. Sumar");
Console.WriteLine("2. Restar");
Console.WriteLine("3. Multiplicar");
...
//Uso de while para menú de opciones
while (texto != "5")
{
    switch (texto)
    {
        ...
        case "4":
            ...
            Console.WriteLine("El resultado de la división es: " + (num7 / num8));
            break;
        //En el caso del while, la opción de salida no es necesaria, ya que el while se encarga de salir
        default:
            Console.WriteLine("Opción no valida");
            break;
    }
...
//Se imprime el texto de salida una vez que se sale del while, ya que la opción de salida no está en el switch dentro del while
Console.WriteLine("Saliendo...");
