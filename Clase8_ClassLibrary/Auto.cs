...
namespace Clase8_ClassLibrary
{
    public class Auto
    {
        ...
        public Persona Conductor { get; set; } //Relaciones entre clases u objetos (Asociación)
        //Como la propiedad es pública permite Inyección de Dependencia por Propiedad
        ...
        //Agregar conductor
        //Esto es una Inyección de Dependencias por Método
